...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      <>· 本界面底部提供「<b>导出模板</b>」按钮：将 516×516 的布局模板一键导出到桌面，供 AI 生图参考。</>,
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      <>· <b>对齐微调</b>（仅图片导入 · 切图路径生效）：开启后点击选中一块基础块，其裁切选框会高亮；用方向键（↑↓←→）移动选框在源图中的位置，实时从源图重切该块像素以对齐素材边界。选框可移出图片范围，越界部分从对侧回绕取样。</>,
    ],
  },
  {
